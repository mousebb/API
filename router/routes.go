...
var routes = []Route{
	...
	// Product Management
	// Route{"Get Part", "GET", "/parts/:part", middleware.APIHandler{H: partCtlr.PartNumber, Middleware: common}},
	...
	// Route{"Get Part Vehicles", "GET", "/parts/:part/vehicles", middleware.APIHandler{H: partCtlr.Vehicles, Middleware: common}},
	// Route{"Get Part Attributes", "GET", "/parts/:part/attributes", middleware.APIHandler{H: partCtlr.Attributes, Middleware: common}},
	// Route{"Get Part Reviews", "GET", "/parts/:part/reviews", middleware.APIHandler{H: partCtlr.ActiveApprovedReviews, Middleware: common}},
	// Route{"Get Part Categories", "GET", "/parts/:part/categories", middleware.APIHandler{H: partCtlr.Categories, Middleware: common}},
	// Route{"Get Part Content", "GET", "/parts/:part/content", middleware.APIHandler{H: partCtlr.GetContent, Middleware: common}},
	// Route{"Get Part Images", "GET", "/parts/:part/images", middleware.APIHandler{H: partCtlr.Images, Middleware: common}},
	// Route{"Get Part Installation Sheet", "GET", "/parts/:part.pdf", middleware.APIHandler{S: partCtlr.InstallSheet, Middleware: common}},
	// Route{"Get Part Packages", "GET", "/parts/:part/packages", middleware.APIHandler{H: partCtlr.Packaging, Middleware: common}},
	// Route{"Get Part Pricing", "GET", "/parts/:part/pricing", middleware.APIHandler{H: partCtlr.Prices, Middleware: common}},
	// Route{"Get Related Parts", "GET", "/parts/:part/related", middleware.APIHandler{H: partCtlr.GetRelated, Middleware: common}},
	// Route{"Get Videos", "GET", "/parts/:part/videos", middleware.APIHandler{H: partCtlr.Videos, Middleware: common}},
	// Route{"Get Part with Vehicle", "GET", "/parts/:part/:year/:make/:model/:submodel", middleware.APIHandler{H: partCtlr.GetWithVehicle, Middleware: common}},
	// Route{"Get Part with Vehicle Config", "GET", "/parts/:part/:year/:make/:model/:submodel/:config", middleware.APIHandler{H: partCtlr.GetWithVehicle, Middleware: common}},
