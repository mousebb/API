...
var routes = []Route{
	...
	Route{"Get Part Vehicles", "GET", "/part/:part/vehicles", middleware.APIHandler{H: partCtlr.GetVehicles, Middleware: common}},
	Route{"Get Part Attributes", "GET", "/part/:part/attributes", middleware.APIHandler{H: partCtlr.GetAttributes, Middleware: common}},
	...
	// Route{"Get Part", "GET", "/parts/:part", middleware.APIHandler{H: partCtlr.Get, Middleware: common}},
