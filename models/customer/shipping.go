...
// 	u := "http://146.148.89.23:8080/shipping?id=" + strconv.Itoa(c.CustomerNumber)
// 	client := &http.Client{}
...
// }
//
// func (a *ComnetAccount) adjustFreight(limit float64, ctx *middleware.APIContext) error {
//
...
// }
//
// func (a *ComnetAccount) adjustWarehouse(id int, ctx *middleware.APIContext) error {
//
